...
<div class='col-md-9'>
	...
	?>
		<div class="breadcrumb" style="border-bottom:1px solid #f4f4f4;padding-bottom: 10px;">
			<div class="container">
				<div class="breadcrumb-inner">
					<ul class="list-inline list-unstyled">
						<li><a href="index.php">Home</a></li>
						<li><a href="category.php?categoryname=<?php echo $_GET['categoryname'];?>"><?php echo $_GET['categoryname'];?></a></li>
						<li><a href="category_brand.php?categoryname=<?php echo $_GET['categoryname'];?>&brandname=<?php echo $_GET['brandname'];?>"><?php echo $_GET['brandname'];?></a></li>
						<li class='active'><?php echo $row_detail['name'];?></li>
					</ul>
