							...
							<div class="tab-pane active"  id="list-container">
									...
									<div class="container">
										<div class="breadcrumb-inner">
											<ul class="list-inline list-unstyled">
												...
												<li class='active'><?php echo $_GET["categoryname"];?></li>
											</ul>
								...
								<div class="category-product  inner-top-vs">
									...
									if (!isset($_GET['sortby'])){
										$query_items = mysqli_query($con, "SELECT *,SUM(stock) as tStock, MIN(daterestock) AS mindaterestock FROM tbl_prod WHERE categoryname='$_GET[categoryname]' GROUP BY code;");
									}

									else {
										if ($_GET['sortby']==1){
											$query_items = mysqli_query($con, "SELECT *,SUM(stock) as tStock, MIN(daterestock) AS mindaterestock FROM tbl_prod WHERE categoryname='$_GET[categoryname]' GROUP BY code ORDER BY price ASC;");
										}

										else {
											$query_items = mysqli_query($con, "SELECT *,SUM(stock) as tStock, MIN(daterestock) AS mindaterestock FROM tbl_prod WHERE categoryname='$_GET[categoryname]' GROUP BY code ORDER BY price DESC;");
										}
									}
									?>
																...
																<div class="products">
																	<div class="product-list product">
																		<div class="row product-list-row">
																			<div class="product-info" style="padding: 0px 0px 20px 40px;">
																				<h3 class="name"><a href="category_detail.php?categoryname=<?php echo $row_items['categoryname'];?>&brandname=<?php echo $row_items['brandname'];?>&code=<?php echo $row_items['code'];?>"><?php echo $row_items['name'];?></a></h3>
																	...
																	<?php echo $row_items['des'];?></div>
																		<div class="cart clearfix animate-effect">
																			<div class="action">
																				<a href="category_detail.php?categoryname=<?php echo $row_items['categoryname'];?>&brandname=<?php echo $row_items['brandname'];?>&code=<?php echo $row_items['code'];?>" class="btn btn-primary">
