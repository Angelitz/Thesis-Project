    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Ready for Delivery</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="dataTable_wrapper">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody><?php
                                    $tbl_order = mysqli_query($con, "SELECT *, SUM(qty) AS tQty FROM tbl_order WHERE orderstatus='Ready For Delivery' GROUP BY invoice ORDER BY eta ASC;");
                                    $counter=1;
                                    ...
                                    <td><a href="delivery_voice.php?invoice=<?php echo $row_order['invoice'];?>" class="btn btn-primary btn-block btn-sm btn-outline"><i class="fa fa-eye"></i>&nbsp;View</a></td>
                                    </tr><?php
                                    $counter++;
                                    }?>
                                </tbody>
