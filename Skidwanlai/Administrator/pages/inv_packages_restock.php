    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><a href="inv_packages.php" class="page-header-link">Computer Packages</a> <small>Restock Package</small></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                ...
                <?php
                    ...
                    if(isset($_POST['up'])){
                        if ($_GET['daterestock']!=date('Y-m-d')){
                            ...
                            ?>
                            <script>
                                window.location.href="inv_packages.php?res_success";
                            </script>
                            <?php
                        }
