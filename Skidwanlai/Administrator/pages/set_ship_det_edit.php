...
<?php   session_start();
        ...
        $sql_ship_edit = mysqli_query($con, "SELECT * FROM tbl_shippingfee WHERE shipid=$_GET[shipid];");
        $row_ship_edit = mysqli_fetch_assoc($sql_ship_edit);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><a href="set_ship_det.php" class="page-header-link">Shipping Fees</a> <small>Edit: <?php echo $row_ship_edit['shipday'];?></small></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="hidden" value="<?php echo $row_ship_edit['shipid'];?>" name="shipid"/>
                            ...
                            <input type="text" disabled required name="shipday" value="<?php echo $row_ship_edit['shipday'];?>" class="form-control unicase-form-control text-input"/>
                        </div>
                        <div class="form-group">
                            <label style="font-size: 14px;font-weight: 400;">Shipping Cost</label>
                            <input type="number" autofocus min="1" step="0.01" value="<?php echo $row_ship_edit['cost'];?>" required name="cost" class="form-control unicase-form-control text-input"/>
                        </div>
                        <div class="form-group pull-right">
                            <button type="submit" value="Save" name="saveship" class="btn btn-primary btn-outline btn-sm"><i class="fa fa-save"></i>&nbsp;&nbsp;Save</button>
                        </div>
                        </form>
                    </div>
                    <!-- /.col-lg-6 -->
