    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><a href="inv_hardware.php" class="page-header-link">Computer Hardware</a> <small>New Product</small></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                ...
                <?php
                    ...
                    echo "<script>window.location='inv_hardware.php?add_success';</script>";
                  }
                                ?>
                    <div class="col-lg-12">
                        <form method="post" id="frm" enctype="multipart/form-data">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input maxlength="900" required type="text" autofocus name="pname" onkeyup="mySubmit();" onclick="mySubmit();" class="form-control unicase-form-control text-input"/>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select id="categoryname" name="categoryname" class="form-control unicase-form-control text-input">
                                    <?php
                                        $query_select_category = mysqli_query($con, "SELECT * FROM tbl_category ORDER BY categoryname;");
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select id="brandname" name="brandname" class="form-control unicase-form-control text-input">
                                    <?php
                                    $sql_brand = mysqli_query($con, "SELECT * FROM tbl_brand ORDER BY brandname;");
