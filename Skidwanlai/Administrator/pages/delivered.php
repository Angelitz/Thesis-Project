                    ...
                    <div class="col-lg-12">
                        <div class="dataTable_wrapper">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody><?php
                                    $tbl_order = mysqli_query($con, "SELECT *, SUM(qty) AS tQty FROM tbl_order WHERE orderstatus='Delivered' GROUP BY invoice ORDER BY datedelivered ASC;");
                                    $counter=1;
                                    ...
                                    <td><?php echo date('M d, Y', strtotime($row_order['datedelivered']));?></td>
                                    <td><?php echo "PHP ".number_format($row_order['grandtotal'], 2);?></td>
                                    <td><a href="delivered_voice.php?invoice=<?php echo $row_order['invoice'];?>" class="btn btn-primary btn-block btn-sm btn-outline"><i class="fa fa-eye"></i>&nbsp;View</a></td>
                                    </tr><?php
                                    $counter++;
                                    }?>
                                </tbody>
