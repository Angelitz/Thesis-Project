    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><a href="index.php" class="page-header-link">Incoming Requests</a> <small>Order Details</small></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-group pull-right">
                            <a href="index.php" class="btn btn-danger btn-outline btn-sm"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;Back</a>&nbsp;&nbsp;
                            ...
                            <a href="#" data-toggle="modal" data-target="#confirm_accept" class="btn btn-success btn-outline btn-sm"><i class="fa fa-check"></i>&nbsp;&nbsp;Ready for Delivery</a>
                            <a href="#" data-toggle="modal" data-target="#confirm_decline" class="btn btn-danger btn-outline btn-sm"><i class="fa fa-ban"></i>&nbsp;&nbsp;Decline Order</a>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="panel panel-green" style="width:300px; margin: auto; margin-top: 25%;">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <label style="font-size: 14px;font-weight: 400;">Accept this order and ready for delivery?</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <form method="post" action="function/order_red.php">
                ...
                <div class="modal fade" id="confirm_decline" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="panel panel-green" style="width:300px; margin: auto; margin-top: 25%;">
                            <div class="panel-heading">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                    <label style="font-size: 14px;font-weight: 400;">Decline this order?</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <form method="post" action="function/order_decline.php">
                                            <button type="button" class="btn btn-danger btn-outline" data-dismiss="modal">No</button>&nbsp;&nbsp;
                                            <input type="hidden" value="<?php echo $_GET['invoice'];?>" name="invoice">
                                            <input type="submit" name="ok" id="ii" value="Yes" class="btn btn-primary btn-outline">
                                        </form>
