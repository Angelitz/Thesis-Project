    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Computer Hardware</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="dataTable_wrapper">
                            ...
                            if(isset($_GET['mark_success'])){ ?>
                                <div class="alert alert-success alert-dismissable">
                                <button class="close" aria-hidden="true" type="button" data-dismiss="alert">×</button>
                                Product markdown updated successfully!
                                </div><?php
                            }
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                $show=mysqli_query($con,"SELECT *, SUM(stock) AS tStock, max(daterestock) AS maxdaterestock FROM tbl_prod WHERE categoryname!='Desktop Package' GROUP BY code ORDER BY maxdaterestock DESC;");
                                    ...
                                    echo "<tr>";
                                    echo "<td date-toggle='tooltip' data-placement='right' title='Product Code: ".$fet['code']."'>".$counter."</td>";
                ...
                <td>
                  ...
                  <a href="inv_hardware_more.php?id=<?php echo $fet['code']; ?>" target="_parent" class="btn btn-primary btn-sm btn-outline"><i class="fa fa-th-list"></i>&nbsp;&nbsp;More</a>
                  <a href="inv_hardware_markdown.php?id=<?php echo $fet['code']; ?>" target="_parent" class="btn btn-primary btn-sm btn-outline"><i class="fa fa-arrow-down"></i></a>
                  <a href="inv_hardware_restock.php?daterestock=<?php echo $fet['maxdaterestock'];?>&stock=<?php echo $fet['stock'];?>&code=<?php echo $fet['code'];?>" target="_parent" class="btn btn-primary btn-sm btn-outline"><i class="fa fa-plus"></i></a>
                                </td>
