    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><a href="index.php" class="page-header-link">Delivered</a> <small>Order Details</small></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-group pull-right">
                            ...
                            <?php
                            $chk_acc = mysqli_query($con, "SELECT orderstatus FROM tbl_order WHERE invoice=$_GET[invoice];");
                            if (mysqli_num_rows($chk_acc)>0){
                                $row_chk = mysqli_fetch_assoc($chk_acc);
                                if ($row_chk['orderstatus']=='Processing'){ ?>
                                    <a href="#" data-toggle="modal" data-target="#confirm_accept" class="btn btn-success btn-outline btn-sm"><i class="fa fa-check"></i>&nbsp;&nbsp;Ready for Delivery</a> <?php
                                }
                                if ($row_chk['orderstatus']=='Ready for Delivery'){ ?>
                                    <a href="#" data-toggle="modal" data-target="#confirm_deliver" class="btn btn-success btn-outline btn-sm"><i class="fa fa-check"></i>&nbsp;&nbsp;Delivered</a><?php
                                }
                            } ?>
                        </form>
                    </div>
