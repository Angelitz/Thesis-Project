    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><a href="inv_hardware.php" class="page-header-link">Computer Hardware</a> <small>More</small></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="dataTable_wrapper">
                            ...
                            ?>
                              <tr>
                                <td date-toggle="tooltip" data-placement="right" title="<?php echo "Product Code: ".$row_inv['code']?>"><?php echo $counter; ?></td>
                                ...
                                <td date-toggle="tooltip" data-placement="right" title="<?php echo $row_inv['categoryname']?>" style="max-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo $row_inv["categoryname"];?>
                                </td>
                                <td date-toggle="tooltip" data-placement="right" title="<?php echo $row_inv['brandname']?>" style="max-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo $row_inv["brandname"];?>
                                </td>
                                ...
                                <td><a href="inv_hardware_more_edit.php?code=<?php echo $row_inv['code'];?>&daterestock=<?php echo $row_inv['daterestock'];?>" class="btn btn-primary btn-block btn-sm btn-outline"><i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit</a></td>
                              </tr>
                            <?php  
                            $counter++;
                            }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a class="btn btn-danger btn-outline btn-sm" href="inv_hardware.php"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;Back</a>&nbsp;&nbsp;
                            <a href="inv_hardware_more_edit_all.php?code=<?php echo $_GET['id'];?>" class="btn btn-primary btn-sm btn-outline"><i class="fa fa-pencil"></i>&nbsp;&nbsp;Edit All</a>
                        </div>
                    </div>
                </div>
            </div>
